...
from pgmpy.kltools.utilityFunctions import KLDivergenceAlt2, KLDivergenceAlt1Pair
from pgmpy.readwrite import BIFReader

############################################################
# compares the times for computing KL with both methods. The
# computation for the new method is performed with single
# engine trying to explote all its advantages
############################################################
