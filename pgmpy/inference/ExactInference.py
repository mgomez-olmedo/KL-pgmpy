...
class VariableElimination(Inference):
    ...
    def _variable_elimination(
        ...
        print("factors in final distribution")
        for factor in final_distribution:
            print(factor)
        print("********************************************************")
        ...
        if joint:
            if isinstance(self.model, BayesianModel):
                ...
                print("final complete factor before normalization: ")
                print(completeFactor)
                # normalize
                normalizedFactor = completeFactor.normalize(inplace=False)
                print("normalized factor: ")
                print(normalizedFactor)
